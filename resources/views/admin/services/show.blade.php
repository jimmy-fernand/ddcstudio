            ...
            <div class="col-md-6 col-sm-12">
                ...
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"style="color: #d88c3c;">Show Service</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <form action="{{ route("admin.service.update",["id"=>$service->id]) }}" method="POST"
                ...
                <div class="form-group row"><label class="col-sm-12 col-md-2 col-form-label">Title</label>
                    <div class="col-sm-12 col-md-10"><input
                            ...
                            @enderror"
                            name="title" type="text" value="{{ $service->title }}" placeholder="title">
                        <div class="invalid-feedback">{{ $errors->first('title') }} </div>
                    </div>
                </div>
                <div class="form-group row"><label class="col-sm-12 col-md-2 col-form-label">Description</label>
                    <div class="col-sm-12 col-md-10">
                        <textarea name="description" class="form-control @error('description') is-invalid @enderror">{{ $service->description }}</textarea>
                ...
                <div class="form-group row justify-content-between">
                    <div style="margin: 5px 203px;">
                        <a href="{{ route('admin.service.index') }}" class="btn btn-dark "> Return</a>
                    </div>
